        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BachelorStartDate = table.Column<DateTime>(nullable: false),
                    BachelorProjectTitle = table.Column<string>(nullable: true),
                    BachelorThesisTitle = table.Column<string>(nullable: true),
                    BachelorGradDate = table.Column<DateTime>(nullable: false),
                    MasterFocus = table.Column<string>(nullable: true),
                    MasterStartDate = table.Column<DateTime>(nullable: false),
                    CommFormedDate = table.Column<DateTime>(nullable: false),
                    MasterDefenseDate = table.Column<DateTime>(nullable: false),
                    MasterProjectTitle = table.Column<string>(nullable: true),
                    MasterThesisTitle = table.Column<string>(nullable: true),
                    MasterGraduationDate = table.Column<DateTime>(nullable: false),
                    DoctoralCandidate = table.Column<bool>(nullable: false),
                    DateAcceptedForCandidacy = table.Column<DateTime>(nullable: false),
                    DissertationDefenseDate = table.Column<string>(nullable: true),
